...
namespace Ticket.Core.Service
{
    public class OrderDetailService
    {
        ...
        public Tbl_OrderDetail GetByQRcode(string qRcode)
        {
            return _orderDetailRepository.FirstOrDefault(a => a.QRcode == qRcode);
        }
        ...
        /// <returns></returns>
        public Tbl_OrderDetail XJ_CheckOrderDetailIsUpdate(int otaOrderDetailId)
        {

...
namespace Ticket.Application
{
    public class TVMFacadeService
    {
        ...
        /// </summary>
        /// <returns></returns>
        public TVMResult<GUITikcetConfig> GetTicketList()
        {
            ...
            var ticketList = _ticketService.GetScanTicketList(UserKey.ScenicId, DateTime.Now.Date);
        ...
        public TVMResult<TVMTicketInfo[]> GetTicketOrder(string number, int CheckType)
        {
            ...
            foreach (var orderDetail in orderDetails)
            {
                ...
                ticketInfos.Add(new TVMTicketInfo
                {
                    ...
                    GeneralPrice = (double)orderDetail.SettlementPrice,//门票票面价格
        ...
        public TVMExtendData GetScanTicketList(TVMExtendData model)
        {
            ...
            var ticketList = _ticketService.GetScanTicketList(UserKey.ScenicId, queryData.playTime);
